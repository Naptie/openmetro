...
declare const apiLineStatusSchema: z.ZodEnum<["operating", "under_construction"]>;
declare const apiLineSchema: z.ZodObject<{
    ...
    status: z.ZodEnum<["operating", "under_construction"]>;
    loop: z.ZodBoolean;
}, "strip", z.ZodTypeAny, {
...
declare const apiStationStatusSchema: z.ZodEnum<["operating", "out_of_service", "under_construction"]>;
declare const apiStationSchema: z.ZodObject<{
    ...
    status: z.ZodEnum<["operating", "out_of_service", "under_construction"]>;
...
declare const apiTravelTimeSourceSchema: z.ZodEnum<["source", "planner", "last_train", "estimated"]>;
declare const apiSegmentSchema: z.ZodObject<{
    ...
    travel_time_source: z.ZodOptional<z.ZodEnum<["source", "planner", "last_train", "estimated"]>>;
...
declare const apiLayerQualitySchema: z.ZodObject<{
    precision: z.ZodEnum<["official", "derived", "default"]>;
    coverage: z.ZodNumber;
    status: z.ZodEnum<["complete", "partial", "derived", "unavailable"]>;
...
declare const apiNetworkQualitySchema: z.ZodObject<{
    ...
    fares: z.ZodOptional<z.ZodObject<{
        precision: z.ZodEnum<["official", "derived", "default"]>;
        coverage: z.ZodNumber;
        status: z.ZodEnum<["complete", "partial", "derived", "unavailable"]>;
        counts: z.ZodRecord<z.ZodString, z.ZodNumber>;
...
declare const apiSchemas: {
    ...
    ApiLineStatus: z.ZodEnum<["operating", "under_construction"]>;
    ApiLine: z.ZodObject<{
        id: z.ZodString;
        name: z.ZodString;
        names: z.ZodObject<{
    ...
    ApiStationStatus: z.ZodEnum<["operating", "out_of_service", "under_construction"]>;
    ...
    ApiTravelTimeSource: z.ZodEnum<["source", "planner", "last_train", "estimated"]>;
